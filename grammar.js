...
module.exports = grammar({
    ...
    rules: {
        ...
        ARROW: $ => token(choice('->', '→')),
        LAMBDA: $ => token(choice('\\', 'λ')),
        ELLIPSIS: $ => token(choice('...', '…')),
        ...
        _simple_top_hole: $ => choice(
            $.id,
            paren($.LAMBDA, $.bid, $.ARROW, $.id),
        ),

        // SimpleHole
        _simple_hole: $ => choice(
            $.id,
            seq($.LAMBDA, $.bid, $.ARROW, $.id),
        ),
        ...
        // Expr
        expr: $ => choice(
            seq($._typed_bindings, $.ARROW, $.expr),
            seq(optional($.attributes), $._atoms, $.ARROW, $.expr),
        ...
        // ForallBindings
        forall: $ => seq($.FORALL, $._typed_untyped_bindings, $.ARROW, $.expr),
